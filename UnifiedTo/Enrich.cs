...
namespace UnifiedTo
{
    ...
    public class Enrich: IEnrich
    {
        ...
        public Enrich(ISpeakeasyHttpClient client, Func<UnifiedTo.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListEnrichPeopleResponse> ListEnrichPeopleAsync(ListEnrichPeopleRequest request)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "listEnrichPeople", new List<string> {  }, _securitySource);
