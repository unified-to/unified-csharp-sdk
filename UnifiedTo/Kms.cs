...
namespace UnifiedTo
{
    ...
    public class Kms: IKms
    {
        ...
        public async Task<CreateKmsCommentResponse> CreateKmsCommentAsync(KmsComment kmsComment, string connectionId, List<string>? fields = null)
        {
            ...
            var hookCtx = new HookContext("createKmsComment", null, _securitySource);
        ...
        public async Task<GetKmsCommentResponse> GetKmsCommentAsync(string connectionId, string id, List<string>? fields = null)
        {
            ...
            var hookCtx = new HookContext("getKmsComment", null, _securitySource);
        ...
        public async Task<ListKmsCommentsResponse> ListKmsCommentsAsync(ListKmsCommentsRequest request)
        {
            ...
            var hookCtx = new HookContext("listKmsComments", null, _securitySource);
        ...
        public async Task<PatchKmsCommentResponse> PatchKmsCommentAsync(KmsComment kmsComment, string connectionId, string id, List<string>? fields = null)
        {
            ...
            var hookCtx = new HookContext("patchKmsComment", null, _securitySource);
        ...
        public async Task<RemoveKmsCommentResponse> RemoveKmsCommentAsync(string connectionId, string id)
        {
            ...
            var hookCtx = new HookContext("removeKmsComment", null, _securitySource);
        ...
        public async Task<UpdateKmsCommentResponse> UpdateKmsCommentAsync(KmsComment kmsComment, string connectionId, string id, List<string>? fields = null)
        {
            ...
            var hookCtx = new HookContext("updateKmsComment", null, _securitySource);
