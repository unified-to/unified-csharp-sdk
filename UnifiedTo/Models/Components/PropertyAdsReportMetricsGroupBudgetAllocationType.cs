...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsGroupBudgetAllocationType : IEquatable<PropertyAdsReportMetricsGroupBudgetAllocationType>, IOpenEnum<string>
    {
