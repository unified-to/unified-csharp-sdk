...
namespace UnifiedTo.Models.Components
{
    ...
    public class AccountingCreditmemoPaymentCollectionMethod : IEquatable<AccountingCreditmemoPaymentCollectionMethod>, IOpenEnum<string>
    {
