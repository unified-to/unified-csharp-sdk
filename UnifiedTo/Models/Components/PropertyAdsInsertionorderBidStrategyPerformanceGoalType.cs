...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsInsertionorderBidStrategyPerformanceGoalType : IEquatable<PropertyAdsInsertionorderBidStrategyPerformanceGoalType>, IOpenEnum<string>
    {
