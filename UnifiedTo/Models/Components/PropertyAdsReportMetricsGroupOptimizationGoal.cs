...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsGroupOptimizationGoal : IEquatable<PropertyAdsReportMetricsGroupOptimizationGoal>, IOpenEnum<string>
    {
