...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsGroupTargetingContentVideoDurations : IEquatable<PropertyAdsReportMetricsGroupTargetingContentVideoDurations>, IOpenEnum<string>
    {
