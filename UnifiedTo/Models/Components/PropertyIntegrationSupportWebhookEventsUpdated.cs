...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyIntegrationSupportWebhookEventsUpdated : IEquatable<PropertyIntegrationSupportWebhookEventsUpdated>, IOpenEnum<string>
    {
