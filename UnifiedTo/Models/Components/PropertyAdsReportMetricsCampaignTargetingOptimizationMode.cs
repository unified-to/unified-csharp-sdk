...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsCampaignTargetingOptimizationMode : IEquatable<PropertyAdsReportMetricsCampaignTargetingOptimizationMode>, IOpenEnum<string>
    {
