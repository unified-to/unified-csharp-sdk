...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsInsertionorderBidStrategyYoutubeAndPartnersType : IEquatable<PropertyAdsInsertionorderBidStrategyYoutubeAndPartnersType>, IOpenEnum<string>
    {
