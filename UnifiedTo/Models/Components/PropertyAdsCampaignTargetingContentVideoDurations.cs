...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsCampaignTargetingContentVideoDurations : IEquatable<PropertyAdsCampaignTargetingContentVideoDurations>, IOpenEnum<string>
    {
