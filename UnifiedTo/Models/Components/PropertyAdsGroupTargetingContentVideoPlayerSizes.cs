...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsGroupTargetingContentVideoPlayerSizes : IEquatable<PropertyAdsGroupTargetingContentVideoPlayerSizes>, IOpenEnum<string>
    {
