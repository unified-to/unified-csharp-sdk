...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsCampaignAdvertisingChannelType : IEquatable<PropertyAdsReportMetricsCampaignAdvertisingChannelType>, IOpenEnum<string>
    {
