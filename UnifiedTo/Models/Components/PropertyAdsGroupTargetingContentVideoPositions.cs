...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsGroupTargetingContentVideoPositions : IEquatable<PropertyAdsGroupTargetingContentVideoPositions>, IOpenEnum<string>
    {
