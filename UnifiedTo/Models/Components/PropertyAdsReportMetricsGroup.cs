...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsGroup
    {
        ...
        public PropertyAdsReportMetricsGroupCreativeSelection? CreativeSelection { get; set; }

        [JsonProperty("currency")]
        public string? Currency { get; set; }

        [JsonProperty("effective_status")]
        public PropertyAdsReportMetricsGroupEffectiveStatus? EffectiveStatus { get; set; }
