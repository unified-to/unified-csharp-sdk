...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsGroupTargetingGeographicLocationTypes : IEquatable<PropertyAdsGroupTargetingGeographicLocationTypes>, IOpenEnum<string>
    {
