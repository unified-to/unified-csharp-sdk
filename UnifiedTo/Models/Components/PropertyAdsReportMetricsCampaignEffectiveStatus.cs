...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsCampaignEffectiveStatus : IEquatable<PropertyAdsReportMetricsCampaignEffectiveStatus>, IOpenEnum<string>
    {
