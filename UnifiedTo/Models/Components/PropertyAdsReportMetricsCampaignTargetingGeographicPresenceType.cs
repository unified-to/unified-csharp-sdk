...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsCampaignTargetingGeographicPresenceType : IEquatable<PropertyAdsReportMetricsCampaignTargetingGeographicPresenceType>, IOpenEnum<string>
    {
