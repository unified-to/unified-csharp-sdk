...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsInsertionorderFrequencyCapTimeUnit : IEquatable<PropertyAdsInsertionorderFrequencyCapTimeUnit>, IOpenEnum<string>
    {
