...
namespace UnifiedTo.Models.Components
{
    ...
    public class PropertyAdsReportMetricsGroupBidStrategyType : IEquatable<PropertyAdsReportMetricsGroupBidStrategyType>, IOpenEnum<string>
    {
