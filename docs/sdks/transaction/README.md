...
var res = await sdk.Transaction.CreateAccountingTransactionAsync("string", new AccountingTransaction() {
    AccountId = "string",
    Id = "<ID>",
...
var res = await sdk.Transaction.GetAccountingTransactionAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Transaction.ListAccountingTransactionsAsync(new ListAccountingTransactionsRequest() {
    ConnectionId = "string",
...
var res = await sdk.Transaction.PatchAccountingTransactionAsync("string", "string", new AccountingTransaction() {
    AccountId = "string",
    Id = "<ID>",
    LineItems = new List<AccountingTransactionLineitem>() {
        new AccountingTransactionLineitem() {
...
var res = await sdk.Transaction.RemoveAccountingTransactionAsync("string", "string");
...
var res = await sdk.Transaction.UpdateAccountingTransactionAsync("string", "string", new AccountingTransaction() {
    AccountId = "string",
    Id = "<ID>",
    LineItems = new List<AccountingTransactionLineitem>() {
        new AccountingTransactionLineitem() {
