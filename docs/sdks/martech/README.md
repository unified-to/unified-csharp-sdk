...
var res = await sdk.Martech.CreateMartechListAsync("string", new MarketingList() {
...
var res = await sdk.Martech.CreateMartechMemberAsync("string", new MarketingMember() {
...
var res = await sdk.Martech.GetMartechListAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Martech.GetMartechMemberAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Martech.ListMartechListsAsync(new ListMartechListsRequest() {
    ConnectionId = "string",
...
var res = await sdk.Martech.ListMartechMembersAsync(new ListMartechMembersRequest() {
    ConnectionId = "string",
    Fields = new List<string>() {
        "string",
    },
...
var res = await sdk.Martech.PatchMartechListAsync("string", "string", new MarketingList() {
    Raw = new PropertyMarketingListRaw() {},
});
...
var res = await sdk.Martech.PatchMartechMemberAsync("string", "string", new MarketingMember() {
    Emails = new List<MarketingEmail>() {
        new MarketingEmail() {
...
var res = await sdk.Martech.RemoveMartechListAsync("string", "string");
...
var res = await sdk.Martech.RemoveMartechMemberAsync("string", "string");
...
var res = await sdk.Martech.UpdateMartechListAsync("string", "string", new MarketingList() {
    Raw = new PropertyMarketingListRaw() {},
});
...
var res = await sdk.Martech.UpdateMartechMemberAsync("string", "string", new MarketingMember() {
    Emails = new List<MarketingEmail>() {
        new MarketingEmail() {
