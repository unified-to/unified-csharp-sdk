...
var res = await sdk.Note.CreateTicketingNoteAsync("string", new TicketingNote() {
...
var res = await sdk.Note.GetTicketingNoteAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Note.ListTicketingNotesAsync(new ListTicketingNotesRequest() {
    ConnectionId = "string",
...
var res = await sdk.Note.PatchTicketingNoteAsync("string", "string", new TicketingNote() {
    Raw = new PropertyTicketingNoteRaw() {},
});
...
var res = await sdk.Note.RemoveTicketingNoteAsync("string", "string");
...
var res = await sdk.Note.UpdateTicketingNoteAsync("string", "string", new TicketingNote() {
    Raw = new PropertyTicketingNoteRaw() {},
});
