...
var res = await sdk.Document.CreateAtsDocumentAsync("string", new AtsDocument() {
...
var res = await sdk.Document.GetAtsDocumentAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Document.ListAtsDocumentsAsync(new ListAtsDocumentsRequest() {
    ConnectionId = "string",
...
var res = await sdk.Document.PatchAtsDocumentAsync("string", "string", new AtsDocument() {
    Raw = new PropertyAtsDocumentRaw() {},
});
...
var res = await sdk.Document.RemoveAtsDocumentAsync("string", "string");
...
var res = await sdk.Document.UpdateAtsDocumentAsync("string", "string", new AtsDocument() {
    Raw = new PropertyAtsDocumentRaw() {},
});
