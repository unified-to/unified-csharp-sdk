...
var res = await sdk.Account.CreateAccountingAccountAsync("string", new AccountingAccount() {
    Name = "string",
...
var res = await sdk.Account.GetAccountingAccountAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Account.ListAccountingAccountsAsync(new ListAccountingAccountsRequest() {
    ConnectionId = "string",
...
var res = await sdk.Account.PatchAccountingAccountAsync("string", "string", new AccountingAccount() {
    Name = "string",
    Raw = new PropertyAccountingAccountRaw() {},
});
...
var res = await sdk.Account.RemoveAccountingAccountAsync("string", "string");
...
var res = await sdk.Account.UpdateAccountingAccountAsync("string", "string", new AccountingAccount() {
    Name = "string",
    Raw = new PropertyAccountingAccountRaw() {},
});
