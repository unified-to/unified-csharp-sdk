...
var res = await sdk.File.CreateStorageFile2Async(
...
var res = await sdk.File.GetStorageFile2Async(
    connectionId: "<id>",
    id: "<id>"
);
...
var res = await sdk.File.ListStorageFiles2Async(req);
...
var res = await sdk.File.PatchStorageFile2Async(req);
...
var res = await sdk.File.RemoveStorageFile2Async(
    connectionId: "<id>",
    id: "<id>"
);
...
var res = await sdk.File.UpdateStorageFile2Async(req);
