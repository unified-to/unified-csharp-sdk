...
var res = await sdk.Uc.CreateUcContactAsync("string", new UcContact() {
...
var res = await sdk.Uc.GetUcContactAsync("string", "string", new List<string>() {
    "string",
});
...
var res = await sdk.Uc.ListUcCallsAsync(new ListUcCallsRequest() {
    ConnectionId = "string",
...
var res = await sdk.Uc.ListUcContactsAsync(new ListUcContactsRequest() {
    ConnectionId = "string",
    Fields = new List<string>() {
        "string",
    },
...
var res = await sdk.Uc.PatchUcContactAsync("string", "string", new UcContact() {
    Emails = new List<UcEmail>() {
        new UcEmail() {
...
var res = await sdk.Uc.RemoveUcContactAsync("string", "string");
...
var res = await sdk.Uc.UpdateUcContactAsync("string", "string", new UcContact() {
    Emails = new List<UcEmail>() {
        new UcEmail() {
