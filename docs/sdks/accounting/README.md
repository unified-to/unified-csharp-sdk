...
var res = await sdk.Accounting.CreateAccountingBankfeedtransactionAsync(
    accountingBankfeedtransaction: new AccountingBankfeedtransaction() {
        ...
        Id = "8b0fd802-34c9-4ae6-82e9-4f952f72570e",
        IsPending = true,
        MerchantName = "Reichert, Erdman and Tillman",
        PostedAt = System.DateTime.Parse("2025-03-24T10:28:18.240Z").ToUniversalTime(),
        Reference = "93642593",
        TransactionAt = System.DateTime.Parse("2022-07-27T21:36:58.881Z").ToUniversalTime(),
        Type = AccountingBankfeedtransactionType.Credit,
        UpdatedAt = System.DateTime.Parse("2022-05-23T21:39:30.941Z").ToUniversalTime(),
    },
    connectionId: "<id>"
);
...
var res = await sdk.Accounting.CreateAccountingBillAsync(
    accountingBill: new AccountingBill() {
        ...
        Id = "33e24b2e-27ce-4b75-aeed-bb435e41a9da",
        ...
        PostedAt = System.DateTime.Parse("2024-04-04T22:57:51.533Z").ToUniversalTime(),
        Send = true,
        Status = AccountingBillStatus.Deleted,
        TaxAmount = 0D,
        Term = Term.Net10,
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2025-01-29T19:17:10.104Z").ToUniversalTime(),
...
var res = await sdk.Accounting.CreateAccountingJournalAsync(
    accountingJournal: new AccountingJournal() {
        ...
        Id = "bb0f0dff-145b-43cd-bdab-5d447aaeaf77",
        PostedAt = System.DateTime.Parse("2023-10-19T15:06:14.496Z").ToUniversalTime(),
        Reference = "ullam",
        Source = "crustulum",
        TaxAmount = 78672D,
        UpdatedAt = System.DateTime.Parse("2022-01-01T17:53:31.468Z").ToUniversalTime(),
    },
    connectionId: "<id>"
);
...
var res = await sdk.Accounting.CreateAccountingPurchaseorderAsync(
    accountingPurchaseorder: new AccountingPurchaseorder() {
        ...
        Currency = "ZMW",
        Id = "23de2cb5-b498-41ed-9218-0c33ac7428af",
        Lineitems = new List<AccountingLineitem>() {},
        Metadata = new List<AccountingMetadata>() {},
        PostedAt = System.DateTime.Parse("2025-04-25T21:32:34.799Z").ToUniversalTime(),
        ...
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2021-02-26T04:10:11.504Z").ToUniversalTime(),
    },
    connectionId: "<id>"
);
...
var res = await sdk.Accounting.CreateAccountingTaxrateAsync(
    accountingTaxrate: new AccountingTaxrate() {
        ...
        Id = "29870806-aad7-4f4d-b84d-621792a68dc6",
        IsActive = false,
        Metadata = new List<AccountingMetadata>() {},
        Name = "cogo",
        Rate = 1D,
        UpdatedAt = System.DateTime.Parse("2025-11-05T04:35:51.547Z").ToUniversalTime(),
    },
    connectionId: "<id>"
);
...
var res = await sdk.Accounting.CreateAccountingVendorcreditAsync(
    accountingVendorcredit: new AccountingVendorcredit() {
        ...
        Id = "d1a38edc-3f66-4fcb-891d-edd79756c561",
        Lineitems = new List<AccountingLineitem>() {},
        Metadata = new List<AccountingMetadata>() {},
        Notes = "Conatus cruciamentum decor avaritia tantum.",
        PostedAt = System.DateTime.Parse("2023-09-28T19:52:50.818Z").ToUniversalTime(),
        Status = AccountingVendorcreditStatus.Submitted,
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2023-11-26T18:52:08.268Z").ToUniversalTime(),
    },
    connectionId: "<id>"
);
...
PatchAccountingBankfeedtransactionRequest req = new PatchAccountingBankfeedtransactionRequest() {
    AccountingBankfeedtransaction = new AccountingBankfeedtransaction() {
        ...
        Currency = "SRD",
        Description = "payment transaction at McLaughlin - Schaden using card ending with ****8233 for DOP 574.03 in account ***9523.",
        Id = "0fc1307d-ccb0-4ad5-b909-4b512d0bf2e5",
        IsPending = true,
        MerchantName = "Reichert, Erdman and Tillman",
        PostedAt = System.DateTime.Parse("2025-03-24T10:28:18.249Z").ToUniversalTime(),
        Reference = "93642593",
        TransactionAt = System.DateTime.Parse("2022-07-27T21:36:58.882Z").ToUniversalTime(),
        Type = AccountingBankfeedtransactionType.Credit,
        UpdatedAt = System.DateTime.Parse("2022-05-23T21:39:30.942Z").ToUniversalTime(),
    },
    ConnectionId = "<id>",
    Id = "<id>",
};
...
PatchAccountingBillRequest req = new PatchAccountingBillRequest() {
    AccountingBill = new AccountingBill() {
        ...
        DueAt = System.DateTime.Parse("2019-08-11T20:52:55.321Z").ToUniversalTime(),
        ExtendedNotes = new List<AccountingExtendedNote>() {},
        Id = "6160c364-5450-4cc9-ba3a-2d4afce092e1",
        Lineitems = new List<AccountingLineitem>() {},
        Metadata = new List<AccountingMetadata>() {},
        Notes = "Tutamen cilicium infit.",
        PaymentCollectionMethod = PaymentCollectionMethod.ChargeAutomatically,
        Payments = new List<AccountingPaymentReference>() {},
        PostedAt = System.DateTime.Parse("2024-04-04T22:57:51.571Z").ToUniversalTime(),
        Send = true,
        Status = AccountingBillStatus.Deleted,
        TaxAmount = 0D,
        Term = Term.Net10,
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2025-01-29T19:17:10.149Z").ToUniversalTime(),
        Url = "https://coarse-interviewer.biz/",
    },
    ConnectionId = "<id>",
    Id = "<id>",
...
PatchAccountingJournalRequest req = new PatchAccountingJournalRequest() {
    AccountingJournal = new AccountingJournal() {
        ...
        Currency = "FKP",
        Description = "Calco constans adipisci.",
        Id = "e5eca47d-304e-4c49-9842-997c019017d5",
        PostedAt = System.DateTime.Parse("2023-10-19T15:06:14.508Z").ToUniversalTime(),
        Reference = "ullam",
        Source = "crustulum",
        TaxAmount = 78672D,
        UpdatedAt = System.DateTime.Parse("2022-01-01T17:53:31.474Z").ToUniversalTime(),
    },
    ConnectionId = "<id>",
    Id = "<id>",
};
...
PatchAccountingPurchaseorderRequest req = new PatchAccountingPurchaseorderRequest() {
    AccountingPurchaseorder = new AccountingPurchaseorder() {
        ...
        CreatedAt = System.DateTime.Parse("2020-12-12T07:17:47.021Z").ToUniversalTime(),
        Currency = "ZMW",
        Id = "3536bca1-53c1-485c-b8c1-35a82ae44fd2",
        Lineitems = new List<AccountingLineitem>() {},
        Metadata = new List<AccountingMetadata>() {},
        PostedAt = System.DateTime.Parse("2025-04-25T21:32:34.840Z").ToUniversalTime(),
        ShippingAddress = new PropertyAccountingPurchaseorderShippingAddress() {
            Address1 = "649 Maggio Overpass",
            City = "Lake Jaylan",
            CountryCode = "US",
        ...
        Status = AccountingPurchaseorderStatus.PartiallyRefunded,
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2021-02-26T04:10:11.506Z").ToUniversalTime(),
    },
    ConnectionId = "<id>",
    Id = "<id>",
};
...
PatchAccountingTaxrateRequest req = new PatchAccountingTaxrateRequest() {
    AccountingTaxrate = new AccountingTaxrate() {
        CreatedAt = System.DateTime.Parse("2020-01-04T10:37:56.894Z").ToUniversalTime(),
        Description = "Nemo atrox tricesimus creator aranea.",
        Id = "e64bbee1-5fe2-45a3-92f1-8acbb702edb7",
        IsActive = false,
        Metadata = new List<AccountingMetadata>() {},
        Name = "cogo",
        Rate = 1D,
        UpdatedAt = System.DateTime.Parse("2025-11-05T04:35:51.561Z").ToUniversalTime(),
    },
    ConnectionId = "<id>",
    Id = "<id>",
};
...
PatchAccountingVendorcreditRequest req = new PatchAccountingVendorcreditRequest() {
    AccountingVendorcredit = new AccountingVendorcredit() {
        ...
        Currency = "KGS",
        DueAt = System.DateTime.Parse("2023-05-06T20:38:46.775Z").ToUniversalTime(),
        Id = "97a75202-4674-4274-b873-152f39b61040",
        Lineitems = new List<AccountingLineitem>() {},
        Metadata = new List<AccountingMetadata>() {},
        Notes = "Conatus cruciamentum decor avaritia tantum.",
        PostedAt = System.DateTime.Parse("2023-09-28T19:52:50.823Z").ToUniversalTime(),
        Status = AccountingVendorcreditStatus.Submitted,
        TotalAmount = 0D,
        UpdatedAt = System.DateTime.Parse("2023-11-26T18:52:08.275Z").ToUniversalTime(),
    },
    ConnectionId = "<id>",
    Id = "<id>",
};
