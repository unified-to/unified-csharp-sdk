...
var res = await sdk.Messaging.CreateMessagingChannelAsync(
    messagingChannel: new MessagingChannel() {
        ...
        HasSubchannels = true,
        Id = "08328f90-97d6-45fe-9b14-9e09feda31cd",
        IsActive = false,
        IsPrivate = true,
        Members = new List<MessagingMember>() {},
        Name = "tego",
        UpdatedAt = System.DateTime.Parse("2026-04-23T22:55:17.519Z").ToUniversalTime(),
...
PatchMessagingChannelRequest req = new PatchMessagingChannelRequest() {
    MessagingChannel = new MessagingChannel() {
        ...
        Description = "Dolores tutis.",
        HasSubchannels = true,
        Id = "b5bfbf1f-3d23-48c7-bbfe-528e9d62abf4",
        IsActive = false,
        IsPrivate = true,
        Members = new List<MessagingMember>() {},
        Name = "tego",
        UpdatedAt = System.DateTime.Parse("2026-04-23T22:55:17.530Z").ToUniversalTime(),
        WebUrl = "https://svelte-rule.name/",
    },
    ConnectionId = "<id>",
    Id = "<id>",
